...
export class Session {
  ...
  toJSON(){
    return {
      ...
      parcel: this.parcel ? { id: this.parcel.id, name: this.parcel.name, ha: this.parcel.ha,
        gerkPid: this.parcel.gerkPid ?? null, raba: this.parcel.raba ?? null,
        feature: this.parcel.feature || null } : null,
      note: this.note,
      abLine: this.abLine,
      track: this.track,
      strips: this.strips,
