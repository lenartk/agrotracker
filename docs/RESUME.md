...
Zadnja posodobitev: 2026-09-21, verzija **v5.4.7** (SW cache v28), live na
...
- **Ob VSAKI spremembi PWA zvišaj `APP_CACHE` v `sw.js`** (trenutno v28). Od v4.2.1
...
- `android-wrapper/` — tanek Android WebView + foreground `TrackingService`; isti web UI, native GPS buffer za ozadje in od v2 lokalni Share/file-import prenos IndexedDB backupa.
...
- v5.4.7: polni lokalni backup + neposreden prenos stare PWA → Android wrapper v2; settings/parcele/GERK/seje/sloji se mergeajo lokalno brez strežnika.
